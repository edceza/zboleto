...
uses
  BrookAction, ZBoleto, ZBoletoAnalisadorHtml, ZBoletoModelo_Santander, SysUtils;

type
  TBoletoSantanderAction = class(TBrookAction)
  public
...
procedure TBoletoSantanderAction.Get;
var
  Boleto: TZBoleto;
...
begin
  ...
  try
    ...
    Write(Boleto.Executa('santander', 'html'));
  finally
    Boleto.Free;
  end;
end;
...
initialization
  TBoletoSantanderAction.Register('*');
