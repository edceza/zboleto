...
uses
  BrookAction, ZBoleto, ZBoletoAnalisadorHtml, ZBoletoModelo_SICREDI, SysUtils;

type
  TBoletoSicrediAction = class(TBrookAction)
  public
...
procedure TBoletoSicrediAction.Get;
var
  Boleto: TZBoleto;
...
begin
  ...
  try
    ...
    Write(Boleto.Executa('sicredi', 'html'));
  finally
    Boleto.Free;
  end;
end;
