...
uses
  BrookAction, ZBoleto, ZBoletoAnalisadorHtml, ZBoletoModelo_Bradesco, SysUtils;

type
  TBoletoBradescoAction = class(TBrookAction)
  public
...
procedure TBoletoBradescoAction.Get;
var
  Boleto: TZBoleto;
...
begin
  ...
  try
    ...
    Write(Boleto.Executa('bradesco', 'html'))
  finally
    Boleto.Free;
  end;
end;
...
initialization
  TBoletoBradescoAction.Register('*');
